...
public abstract class QllBaseDTO<Entity extends BaseFWModelImpl> extends BaseFWDTOImpl<Entity> {
	...
	private List<ErrExcelDTO> lstErrorExcel;
	...
	public List<ErrExcelDTO> getLstErrorExcel() {
		return lstErrorExcel;
	}

	public void setLstErrorExcel(List<ErrExcelDTO> lstErrorExcel) {
		this.lstErrorExcel = lstErrorExcel;
	}
