...
public void setStockTransId(Long stockTransId) {
	...
	private List<StockDailyRemainDTO> listStockDailyRemain = Lists.newArrayList();

	public List<StockDailyRemainDTO> getListStockDailyRemain() {
		return listStockDailyRemain;
	}
	public void setListStockDailyRemain(List<StockDailyRemainDTO> listStockDailyRemain) {
	...
	/*test*/
	/*test*/
	private Float tongTd;
	private Float tongDn;
	private String thangGhiNhanQuyLuongTqt;
	private List<Float> listTongTd = Lists.newArrayList();
	private List<Float> listTongDn = Lists.newArrayList();
	private List<String> listThangGhiNhanQuyLuongTqt = Lists.newArrayList();
	public Float getTongTd() {
		return tongTd;
	}
	public void setTongTd(Float tongTd) {
		this.tongTd = tongTd;
	}
	public Float getTongDn() {
		return tongDn;
	}
	public void setTongDn(Float tongDn) {
		this.tongDn = tongDn;
	}
	public String getThangGhiNhanQuyLuongTqt() {
		return thangGhiNhanQuyLuongTqt;
	}
	public void setThangGhiNhanQuyLuongTqt(String thangGhiNhanQuyLuongTqt) {
		this.thangGhiNhanQuyLuongTqt = thangGhiNhanQuyLuongTqt;
	}
	public List<Float> getListTongTd() {
		return listTongTd;
	}
	public void setListTongTd(List<Float> listTongTd) {
		this.listTongTd = listTongTd;
	}
	public List<Float> getListTongDn() {
		return listTongDn;
	}
	public void setListTongDn(List<Float> listTongDn) {
		this.listTongDn = listTongDn;
	}
	public List<String> getListThangGhiNhanQuyLuongTqt() {
		return listThangGhiNhanQuyLuongTqt;
	}
	public void setListThangGhiNhanQuyLuongTqt(List<String> listThangGhiNhanQuyLuongTqt) {
		this.listThangGhiNhanQuyLuongTqt = listThangGhiNhanQuyLuongTqt;
	}
