...
public abstract class imsBaseDTO<Entity extends BaseFWModelImpl> extends BaseFWDTOImpl<Entity> {
	...
	private List<BiddingPackageDTO> lstErrorOrder;
	...
	public List<BiddingPackageDTO> getLstErrorOrder() {
		return lstErrorOrder;
	}

	public void setLstErrorOrder(List<BiddingPackageDTO> lstErrorOrder) {
