angular.module('MetronicApp').factory('createImpReqManaService', ['$http', '$q', 'RestEndpoint', 'Restangular', '$kWindow', function($http, $q, RestEndpoint, Restangular, $kWindow){
	    ...
	    var factory = {
	    		...
	    		doSearchGoodsDetailForImportReq:doSearchGoodsDetailForImportReq,
	    };
	    ...
	    function doSearchGoodsForImportReq(obj) {
			return Restangular.all(RestEndpoint.ORDER_GOOD_SERVICE_URL + "/doSearchGoodsForImportReq").post(obj);
		}
	    function doSearchGoodsDetailForImportReq(obj) {
			return Restangular.all(RestEndpoint.ORDER_GOOD_DETAIL_SERVICE_URL + "/doSearchGoodsDetailForImportReq").post(obj);
		}
