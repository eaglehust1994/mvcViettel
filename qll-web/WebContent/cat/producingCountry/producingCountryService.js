...
angular.module('MetronicApp').factory('producingCountryService', ['$http', '$q', 'RestEndpoint', 'Restangular', '$kWindow', function($http, $q, RestEndpoint, Restangular, $kWindow){
	 	var serviceUrl = RestEndpoint.PRODUCING_COUNTRY_SERVICE_URL;
	    var factory = {
	        remove:remove,
