...
angular.module('MetronicApp').factory('catProvinceService', ['$http', '$q', 'RestEndpoint', 'Restangular', '$kWindow', function($http, $q, RestEndpoint, Restangular, $kWindow){
	 	var serviceUrl = RestEndpoint.CAT_PROVINCE_SERVICE_URL;
	    var factory = {
	        remove:remove,
