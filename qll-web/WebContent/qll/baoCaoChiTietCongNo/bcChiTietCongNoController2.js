(function() {
	'use strict';
	var controllerId = 'bcChiTietCongNoController1';

	angular.module('MetronicApp').controller(controllerId,
			bcChiTietCongNoController1);

	function bcChiTietCongNoController1($scope, $rootScope, $timeout,
...
//									+ 'ng-click="vm.importFile()" uib-tooltip="Import file" translate>Import file</button>'
									+ '<button class="btn btn-qlk padding-search-right margin_right10 excelQLK btn pull-right ng-scope"'
			      					+ 'ng-click="vm.exportExcelGrid()" ng-show="RoleMenu.checkRole.checkRoleXacNhanThongTinftXuatBC" aria-hidden="true" uib-tooltip="Xuất chi tiết" translate>Xuất file</button>'
									+ '</div>'
...
//									+ '<i class="action-button excelQLK" uib-tooltip="Xuất file excel" ng-click="vm.exportExcelGrid()" aria-hidden="true"></i>'
									...
									+ '<label ng-repeat="column in vm.bcCongNoGrid1.columns.slice(1,vm.bcCongNoGrid1.columns.length)| filter: vm.gridColumnShowHideFilter">'
						...
						dataSource : {
							...
							schema : {
								...
								data : function(response) {
									$("#congNoCount1").text("" + response.total);
							...
							transport : {
								...
								parameterMap : function(options, type) {
									...
									vm.CongNoSearch1.page = options.page;
									vm.CongNoSearch1.pageSize = options.pageSize;
//									vm.CongNoSearch1.type="1";
									vm.oldSearch=angular.copy(vm.CongNoSearch1);
									return JSON.stringify(vm.CongNoSearch1);
...
//												 aggregates : [ "sum" ],
		...
		vm.showHideColumn = function(column) {
			if (angular.isUndefined(column.hidden)) {
				vm.bcCongNoGrid1.hideColumn(column);
			} else if (column.hidden) {
				vm.bcCongNoGrid1.showColumn(column);
			} else {
				vm.bcCongNoGrid1.hideColumn(column);
			}
