...
(function() {
    ...
    app.controller('listAssetHandOver',	function($scope,$rootScope, gettextCatalog,Restangular,Constant,
        ...
        vm.columns=[
            //startCloumnHere
            {
                ...
                '<div class="action-button add" uib-tooltip="Tạo" translate>&nbsp;&nbsp;&nbsp;&nbsp;</div>'+
                '</button></div>',
                headerAttributes: {
                    style: "text-align:center;"
                },
            ...
            dataSource: {
                ...
                transport:{
                    read:function (e) {
                        ...
                        Restangular.all("longTermAssetServiceRest/" + 'searchHandOver').post(postParam,pagingParam).then(function (response) {
