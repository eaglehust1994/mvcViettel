angular.module('MetronicApp').factory('GlUnitsGroupService', ['$http', '$q', 'Constant', function ($http, $q, Constant) {

    var SERVICE_URI = Constant.SERVICE_URL + 'adOrgGroupServiceRest/adOrgGroup';
    var SERVICE_GET_ALL = '';
    ...
    var SERVICE_UPDATE = '';
    var SERVICE_DELETE = '/';
    var SERVICE_SEARCH_PARAM = ['value', 'name', 'isDeleted'];
