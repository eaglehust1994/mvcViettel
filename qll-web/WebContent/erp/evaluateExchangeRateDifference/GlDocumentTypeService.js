angular.module('MetronicApp').factory('GlDocumentTypeService', ['$http', '$q', 'Constant', function ($http, $q, Constant) {

    var SERVICE_URI = Constant.SERVICE_URL + 'cDocumentTypeRsService/cDocumentType';
    var SERVICE_GET_ALL = '';
