...
<html lang="en" data-ng-app="MetronicApp">
	...
	<![endif]-->
        ...
        <!-- BEGIN POPUP SCRIPTS -->
		<script src="${pageContext.request.contextPath}/erp/popup/editorPopup.controller.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/congThucForm.controller.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/donViForm.controller.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/baoCaoForm.controller.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/dongMoKy/dongKyNhieuDonVi.controller.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/dongMoKy/moGioiHanNhieuDonVi.controller.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/timKiemPopup.controller.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/timKiemTaiKhoanPopup.controller.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/bangMapKhoanMucPopup.controller.js" type="text/javascript"></script>
		
		<!-- -==== Loading service ====- -->
		<script src="${pageContext.request.contextPath}/erp/popup/UnitsController.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/AccountController.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/CostCenterController.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/ProfitCenterController.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/BudgetController.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/SectionChargesController.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/SalesRegionController.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/DepartmentController.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/ServiceController.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/ProjectCategoryController.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/ProjectTypeController.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/CashFlowController.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/ModalController.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/UploadController.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/erp/popup/scrollHeader.js" type="text/javascript"></script>
		<!-- -==== End Loading service ====- -->
