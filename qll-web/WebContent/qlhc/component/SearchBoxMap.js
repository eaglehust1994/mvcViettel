﻿angular.module('MetronicApp').directive('searchBoxMap', function ($rootScope,RestEndpoint, CommonService, gettextCatalog, $http) {
	        ...
	        function onSave(popupId) {
	            if (popupId == attrs.popupId) {
					...
					if (typeof attrs.eventchange !== "undefined" && attrs.eventchange != null){
						$rootScope.$broadcast(attrs.eventchange, $scope.modelName);
					}
	            }
	        }
